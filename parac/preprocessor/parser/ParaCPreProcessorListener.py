...
class ParaCPreProcessorListener(ParseTreeListener):
    ...
    def enterCompilationUnit(self,
                             ctx: ParaCPreProcessorParser.CompilationUnitContext):
        pass
    ...
    def enterPreProcessorEnd(self,
                             ctx: ParaCPreProcessorParser.PreProcessorEndContext):
        pass

    # Exit a parse tree produced by ParaCPreProcessorParser#preProcessorEnd.
    def exitPreProcessorEnd(self,
                            ctx: ParaCPreProcessorParser.PreProcessorEndContext):
        pass
