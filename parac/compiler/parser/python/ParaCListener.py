...
class ParaCListener(ParseTreeListener):
    ...
    def enterPostfixExpression(self,
    ...
    def enterInclusiveOrExpression(self,
    ...
    def exitStructDeclaratorList(self,
                                 ctx: ParaCParser.StructDeclaratorListContext):
        pass
    ...
    def enterFunctionSpecifier(self,
    ...
    def enterTypeQualifierList(self,
    ...
    def enterParameterTypeList(self,
    ...
    def exitAbstractParameterDeclaration(self,
                                         ctx: ParaCParser.AbstractParameterDeclarationContext):
        pass
    ...
    def enterCompoundStatement(self,
    ...
    def enterExpressionStatement(self,
