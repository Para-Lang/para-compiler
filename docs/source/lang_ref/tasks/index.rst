...
.. note::
    ...
    For each language handling can vary due to the possible restrictions each
    language can provide.

.. warning::

    This entire section and its functionality are at the moment only existent
    in theory. There are no current existing usable examples! This also means
    the syntax or functionality can change!
