...
struct PblVarMeta {
  /// Returns whether the variable is defined. This defaults to false (unless a declaration is used. This is
  /// undefined behaviour though, so IT SHOULD IN NO CASE BE ACCESSED WHEN IT'S ONLY DECLARED!)
  bool defined;
...
#define PblBool_T_DefDefault (PblBool_T) {                 \
    .meta={.defined=false, .byte_size=PblBool_T_Size},     \
    .actual=false                                          \
  }
...
#define PblSize_T_DefDefault (PblSize_T) {                 \
    .meta={.defined=false, .byte_size=PblSize_T_Size},     \
    .actual=0                                              \
  }
...
#define PblChar_T_DefDefault (PblChar_T) {                 \
    .meta={.defined=false, .byte_size=PblChar_T_Size},     \
    .actual=0                                              \
  }
...
#define PblUChar_T_DefDefault (PblUChar_T) {           \
    .meta={.defined=false, .byte_size=PblUChar_T_Size},     \
    .actual=0                                               \
  }
...
#define PblShort_T_DefDefault (PblShort_T) {                \
    .meta={.defined=false, .byte_size=PblShort_T_Size},     \
    .actual=0                                               \
  }
...
#define PblUShort_T_DefDefault (PblUShort_T) {         \
    .meta={.defined=false, .byte_size=PblUShort_T_Size},    \
    .actual=0                                               \
  }
...
#define PblInt_T_DefDefault (PblInt_T) {                  \
    .meta={.defined=false, .byte_size=PblInt_T_Size},     \
    .actual=0                                             \
  }
...
#define PblUInt_T_DefDefault (PblUInt_T) {                 \
    .meta={.defined=false, .byte_size=PblUInt_T_Size},     \
    .actual=0                                              \
  }
...
#define PblLong_T_DefDefault (PblLong_T) {                \
    .meta={.defined=false, .byte_size=PblLong_T_Size},    \
    .actual=0                                             \
  }
...
#define PblULong_T_DefDefault (PblULong_T) {             \
    .meta={.defined=false, .byte_size=PblULong_T_Size},  \
    .actual=0                                            \
  }
...
#define PblLongLong_T_DefDefault (PblLongLong_T) {             \
    .meta={.defined=false, .byte_size=PblLongLong_T_Size},     \
    .actual=0                                                  \
  }
...
#define PblULongLong_T_DefDefault (PblULongLong_T) {           \
    .meta={.defined=false, .byte_size=PblULongLong_T_Size},    \
    .actual=0                                                  \
  }
...
#define PblFloat_T_DefDefault (PblFloat_T) {                \
    .meta={.defined=false, .byte_size=PblFloat_T_Size},     \
    .actual=0                                               \
  }
...
#define PblDouble_T_DefDefault (PblDouble_T) {               \
    .meta={.defined=false, .byte_size=PblDouble_T_Size},     \
    .actual=0                                                \
  }
...
#define PblLongDouble_T_DefDefault (PblLongDouble_T) {           \
    .meta={.defined=false, .byte_size=PblLongDouble_T_Size},     \
    .actual=0                                                    \
  }
