...
class ParaCListener(ParseTreeListener):
    ...
    def enterEntryPointSpecifider(self, ctx:ParaCParser.EntryPointSpecifiderContext):
        pass

    # Exit a parse tree produced by ParaCParser#entryPointSpecifider.
    def exitEntryPointSpecifider(self, ctx:ParaCParser.EntryPointSpecifiderContext):
        pass
