...
class ParaCListener(ParseTreeListener):
    ...
    def enterPreProcessorDirective(self, ctx:ParaCParser.PreProcessorDirectiveContext):
        pass

    # Exit a parse tree produced by ParaCParser#preProcessorDirective.
    def exitPreProcessorDirective(self, ctx:ParaCParser.PreProcessorDirectiveContext):
        pass
